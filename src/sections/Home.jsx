    ...
    <div className="flex flex-col justify-center h-full max-w-4xl mx-auto">
        ...
        {nameText.map((char, index) => (
          <motion.span
            ...
            className={`text-transparent bg-clip-text bg-gradient-to-r ${
              index < 5 ? 'from-white to-gray-400' : 'from-neon-blue to-neon-purple'
      ...
      >
        ...
        <div className="mt-12 flex gap-4">
          <button className="px-6 py-3 bg-neon-blue/10 border-2 border-neon-blue text-neon-blue font-pixel text-xs hover:bg-neon-blue hover:text-black transition-all duration-300 shadow-[0_0_15px_rgba(0,243,255,0.3)]">
            VIEW_PROJECTS
          </button>
          <button className="px-6 py-3 bg-dark-800 border-2 border-neon-purple text-neon-purple font-pixel text-xs hover:bg-neon-purple hover:text-white transition-all duration-300 shadow-[0_0_15px_rgba(138,43,226,0.2)]">
            RESUME.EXE
          </button>
        </div>
      </motion.div>
